...
TR: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "login_sso": "用 SSO 登录",
        "login_no_sso": "未配置 SSO —— 请从内网(VPC)访问，或配置 OIDC。",
        "or": "或",
        "submit": "登录",
        "yes": "是",
        "no": "否",
        # write ops
        "accounts_readonly": "账户由 IdP 首次登录时自动创建、角色按组同步(在 Keycloak 里管理)。",
        "create_key": "新建 Key",
        "revoke": "吊销",
    ...
    "en": {
        ...
        "login_no_sso": "SSO not configured — use internal (VPC) access, or set up OIDC.",
        "or": "or",
        "submit": "Login",
        "yes": "yes",
        "no": "no",
        "accounts_readonly": "Accounts are provisioned on first IdP login; roles sync from groups (manage in Keycloak).",
