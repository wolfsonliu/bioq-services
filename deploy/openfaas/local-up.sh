...
# The per-target file is COMPLETE (common values folded in, generated by
# `make gen-config`); kubectl --from-env-file ignores its # comment lines.
cp "$CONFIG_DIR/gateway.openfaas.env" "$CONF_ENV"
