...
控制台需要打开「异步任务模式」——详见 [新增服务 cookbook](../../engineering/guides/adding-a-new-service.md#fc-异步任务模式控制台配置)。
...
FC 部署 checklist 见 [新增服务 cookbook](../../engineering/guides/adding-a-new-service.md#部署到-fc)。
