...
def _cofold_build(req, inputs, job_dir, settings):
    ...
    # Promera's cofold pipeline uses the schema filename's stem as the
    # output subdir name (output/<stem>/<stem>_seed*_samp*.cif), so save
    # as "cofold.json" instead of the misleading "input.json".
